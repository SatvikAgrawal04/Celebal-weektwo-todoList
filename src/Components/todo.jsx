    ...
    <div className="todo-list-container">
      <div className="logo_container">
        <img
          width="24"
          height="24"
          src="https://img.icons8.com/plumpy/24/todo-list.png"
          alt="todo-list"
        />
        <h1>Todo List</h1>
      </div>
            ...
            {editingTaskId === task.id ? (
              <div className="edit-task">
                ...
                <div className="buttons_container">
                  <button
                    className="edit-save-btn todoButtons"
                    onClick={() => handleEditSave(task.id)}
                  >
                    <SaveIcon />
                  </button>
                  <button
                    className="edit-cancel-btn todoButtons"
